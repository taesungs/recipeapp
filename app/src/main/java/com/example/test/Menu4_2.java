...
public class Menu4_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button favorButton = findViewById(R.id.favor4_2);
        favorButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                favorites.add("알리오올리오(히든천재)"); // Replace "Menu1_1" with the corresponding screen name dynamically if needed
                // Save updated favorites
                editor.putStringSet("favor_buttons", favorites);
                editor.apply();

                Toast.makeText(Menu4_2.this, "즐겨찾기에 레시피 추가", Toast.LENGTH_SHORT).show();
            }
        });
